...
void findStrings(int start,int end1)
{
     if(checkPalindrtrome(start,end1)) res[index].push_back(str.substr(start,end1-start+1));
...
int main()
{
    ...
    while(1){
        ...
        cout<<"min cuts required are "<<res<<" and counter used "<<::counter<<" times\n";
        cout<<"\n\n\n-------------------------------------------------------------------------------\n\n\n";
    }    
    return 0;
}
